...
## 2. Project structure
The project currently has four branches: master, gh-pages, ODATAV3, and WCFDSV4.
...
The [gh-pages](https://github.com/OData/odata.net/tree/gh-pages) branch contains documentation source for OData v4 Lib - tutorials, guides, etc.  The documention source is in Markdown format. It is hosted at [ODataLib Pages](http://odata.github.io/odata.net "ODataLib Pages").
...
### 3.1 Building and Testing in Visual Studio IDE
...
- Microsoft.OData.Full.sln - Product source and full functional tests (excluding test cases in Lite solution). Used to _fully_ test your code.
- Microsoft.OData.E2E.sln - Product source and end-to-end tests.
- Microsoft.OData.Net35 - Solution with product source to be built with .Net Framework version 3.5.
- Microsoft.OData.Net45 - Solution with product source to be built with .Net Framework version 4.5.
- Microsoft.OData.Portable45 - Solution with product source to be built with .Net Framework Portable version 4.5.
- Microsoft.OData.Performance - Product source and performance tests to be built with .Net Framework version 4.6.
...
Open Command Line Window with "**Run as administrator**", cd to the root folder:
...
## 5. Community
### 5.1 Contribution
There are many ways for you to contribute to OData .NET. The easiest way is to participate in discussion of features and issues. You can also contribute by sending pull requests of features or bug fixes to us. Contribution to the documentations is also highly welcomed. Please refer to the [CONTRIBUTION.md](https://github.com/OData/odata.net/blob/master/CONTRIBUTION.md) for more details.

### 5.2 Support
- Team blog<br />Please visit [http://blogs.msdn.com/b/odatateam/](http://blogs.msdn.com/b/odatateam/).
- Feedback<br />Please send mails to [odatafeedback@microsoft.com](mailto:odatafeedback@microsoft.com).
- Questions<br />Ask questions on [Stack Overflow](http://stackoverflow.com/questions/ask?tags=odata) or [OData Discussion](https://groups.google.com/forum/#!forum/odata-discussion).
